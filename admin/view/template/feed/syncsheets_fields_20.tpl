...
<div id="content">
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h3 class="panel-title"><i class="fa fa-pencil"></i> Configure Setting</h3>
    </div>
    ...
    <div class="content">
        ...
        <ul id="tabs" class="nav nav-tabs">
            ...
            <li><a data-toggle="tab" href="#tab-special">Specials</a></li>
            <li><a data-toggle="tab" href="#tab-misc">Miscellaneous</a></li>
        </ul>
      <div class="tab-content">
          ...
          <div class="tab-pane table-responsive" id="tab-attributes">
              <table class="table table-striped table-bordered table-hover">
                  <tr>
